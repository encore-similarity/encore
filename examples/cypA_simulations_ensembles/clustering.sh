...
# command line
cmdline="./similarity.py --load-matrix=minusrmsd_pw.npz --superimpose --convergence=50 --maxiter=500 --preferences=-5.0 --np=$NP --nensembles $nensembles --topology topology.pdb --mode=clustering -v --lambda=0.9"
