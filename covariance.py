...
"""
Covariance calculation --- :mod:`MDAnalysis.analysis.ensemble.covariance`
=====================================================================
...
The module contains functions to calculate the covariance matrix of
...
class EstimatorML:
    ...
    def __call__(self, coordinates, reference_coordinates=None):
        '''
        * coordinates - flattened array of coordiantes
        * reference_coordinates - optional reference to use instead of mean
        '''
...
class EstimatorShrinkage:
    ...
    def __init__(self, shrinkage_parameter=None):
        ...
        * shrinkage_parameter - makes it possible to set the shrinkage parameter explicitly, 
