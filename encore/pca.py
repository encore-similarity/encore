...
"""
Covariance calculation --- :mod:`encore.pca`
=====================================================================

The module contains functions to do principle component analysis of
...
def pca(ensemble,
    ...
    **Arguments:**
    ...
    `estimator` : Estimator object
        which estimator type to use (maximum likelihood, shrinkage). See the covariance module for more details.
    `mass_weighted` : bool
    ...
    **Returns:**
    ...
    `projections` : numpy.array
        coordinates of the provided Ensemble in the PCA space.
